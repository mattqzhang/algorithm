...
Check whether a binary tree is a complete tree or not: A complete binary tree is a binary tree whose all levels except the last level 
are completely filled and all the leaves in the last level are filled as left as possible.
